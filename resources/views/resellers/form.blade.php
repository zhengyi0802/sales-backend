...
<form action="{{ route('resellers.store') }}" method="POST" id="reseller-form">
     @csrf
     ...
     <div class="row">
            ...
            <div class="block">
                <p class="title"><strong>{{ __('resellers.phone') }} : <span class="must">{{ __('tables.must') }}</span></strong></p>
                <p class="input"><input type="text" name="phone" class="form-control"></p>
            </div>
            <div class="block">
                <p class="title"><strong>{{ __('resellers.line_id') }} : <span class="must">{{ __('tables.must') }}{{ __('tables.anonly') }}</span></strong></p>
            ...
            <div class="block">
                <p class="title"><strong>{{ __('resellers.pidnumbers') }} : <span class="must">{{ __('tables.must') }}</span></strong></p>
                <p class="input"><input type="text" name="pid" class="form-control"></p>
            </div>
            <div class="block">
                <p class="title"><strong>{{ __('resellers.address') }} : <span class="must">{{ __('tables.must') }}</span></strong></p>
